        ...
        <div className="prose prose-gray max-w-none">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our collection, use, and storage of your information, including account and usage data, are described in our <a href="/privacy" className="text-violet-600 hover:underline">Privacy Policy</a>. By using the Service, you consent to those practices.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                For questions about these Terms, please contact us via our <a href="/contact" className="text-violet-600 hover:underline">Contact</a> page.
              </p>
            </section>
          </div>
        </div>
