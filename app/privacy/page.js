        ...
        <div className="prose prose-gray max-w-none">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="text-muted-foreground leading-relaxed space-y-3">
                <p>
                  You may access, update, or correct your account information (e.g., email, profile) through your account settings or by contacting us. You may request deletion of your account and associated data by contacting us; we will process such requests in accordance with our policies and applicable law. You may also have rights under local law to access, port, restrict processing, or object to certain uses of your data. To exercise these rights or for questions, contact us via our <a href="/contact" className="text-violet-600 hover:underline">Contact</a> page. You can clear local browser storage via your browser settings.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                If you have questions about this Privacy Policy or our privacy practices, please contact us via our <a href="/contact" className="text-violet-600 hover:underline">Contact</a> page.
              </p>
            </section>
          </div>
        </div>
